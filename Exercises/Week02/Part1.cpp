...
int main (int argc, char** argv) {
        ...
        glutCreateWindow ("Week 2 - Part 1");
        initgl ();
...
void setUpView()
{
    ...
    glLoadIdentity ();
    glOrtho (-6.0, 6.0, -6.0, 6.0, -100, 100);
...
void display (void) {
		...
		glPushMatrix();
            // translate so the origin is not the center of the cube, but one of
            // the vertice as specified in the exercise.
